...
import 'package:triya_app/home/standardcv//profcirtificate.dart';
import 'package:triya_app/home/standardcv//achievments.dart';
import 'package:triya_app/home/standardcv//keyskills.dart';

import 'package:triya_app/home/standardcv/contactinfo.dart';
import 'package:triya_app/home/standardcv/personalstatement.dart';
import 'package:triya_app/home/standardcv/profexp.dart';
import 'acadamichistory.dart';
class StandarCv extends StatefulWidget {
  const StandarCv({Key? key}) : super(key: key);

  @override
  State<StandarCv> createState() => _StandarCvState();
}

class _StandarCvState extends State<StandarCv> {
  File? _image;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(
        ...
        title: const Text("Standard CV",style: TextStyle(color: Colors.black),),
        centerTitle: true,
      ),
            ...
            GestureDetector(
              ...
              child: SizedBox(
                ...
                child:Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: const [
                    Text("Achievements",style: TextStyle(color: Colors.black,fontSize: 17),),
                    Icon(Icons.arrow_right_alt_rounded,size: 30,)
                  ],
                ),
              ),
