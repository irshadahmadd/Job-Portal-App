...
class IndusAwards extends StatefulWidget {
  const IndusAwards({Key? key}) : super(key: key);

  @override
  State<IndusAwards> createState() => _IndusAwardsState();
}

class _IndusAwardsState extends State<IndusAwards> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(
        ...
        title: const Text("Industry Awards",style: TextStyle(color: Colors.black),),
        centerTitle: true,
      ),
