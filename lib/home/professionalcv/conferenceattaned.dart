...
class ConfAtained extends StatefulWidget {
  const ConfAtained({Key? key}) : super(key: key);

  @override
  State<ConfAtained> createState() => _ConfAtainedState();
}

class _ConfAtainedState extends State<ConfAtained> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(
        ...
        title: const Text("Conferences Attained",style: TextStyle(color: Colors.black),),
        centerTitle: true,
      ),
